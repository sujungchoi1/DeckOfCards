...
namespace DeckOfCards
{
    class Program
    {
        static void Main(string[] args)
        {
            // Card card = new Card();
            Deck deck = new Deck();
            Player suj = new Player("Sujung");
            Player dave = new Player("David");
            suj.draw(deck);
            suj.draw(deck);
            suj.draw(deck);
            suj.draw(deck);
            ...
            dave.draw(deck);
            dave.draw(deck);
            // Console.WriteLine(suj.Hand.Count); // how to check what's in player's hand??
            Console.WriteLine($"Suj's holding {suj.Hand[0].suit} of {suj.Hand[0].stringVal}");
            Console.WriteLine($"David is holding {dave.Hand[0].suit} of {dave.Hand[0].stringVal}");
            // Console.WriteLine($"Suj's holding {suj.Hand[1].suit} of {suj.Hand[1].stringVal}");
            Console.WriteLine($"David is holding {dave.Hand[1].suit} of {dave.Hand[1].stringVal}");
            // suj.discard(0);
            Console.WriteLine(suj.Hand.Count);
            Console.WriteLine($"Suj's holding {suj.Hand[0].suit} of {suj.Hand[0].stringVal}");
        }
